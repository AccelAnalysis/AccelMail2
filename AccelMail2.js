...
const Hero = ({ setPage }) => (
  <section className="py-20 px-6 max-w-6xl mx-auto text-center">
    <span className="text-blue-600 font-bold tracking-widest uppercase text-xs">Strategy First. Outreach Second.</span>
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <input type="text" placeholder="Zip Code / Neighborhood" className="p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" />
            ...
            <div className="mt-6 h-64 bg-slate-100 rounded-xl flex items-center justify-center border-2 border-dashed border-slate-300">
              <MapIcon className="w-12 h-12 text-slate-300" />
              <span className="ml-2 text-slate-400 font-medium">Interactive Map Placeholder</span>
            </div>
          </div>
  ...
  const LeadCaptureModal = ({ onClose }) => (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
      <div className="bg-white p-8 rounded-3xl max-w-md w-full shadow-2xl">
        ...
        <p className="text-slate-500 mb-6">Enter your email for our 1-page segmentation checklist + example high-intent lists.</p>
        <div className="space-y-4">
          <input type="text" placeholder="Full Name" className="w-full p-4 border rounded-xl outline-none focus:ring-2 focus:ring-blue-600" />
          <input type="email" placeholder="Work Email" className="w-full p-4 border rounded-xl outline-none focus:ring-2 focus:ring-blue-600" />
          <button 
            onClick={() => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
          ...
          <div className="bg-blue-50 p-10 rounded-3xl border-2 border-blue-100">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="text-sm text-slate-600 mb-4">Connect your CRM or define your signals and we will generate a clean, validated list.</p>
                <button 
                  onClick={() => setPage('launch')}
      ...
      {!emailCaptured && (page === 'results' || page === 'launch') && (
        <LeadCaptureModal onClose={() => setEmailCaptured(true)} />
      )}

      <footer className="mt-20 py-12 border-t border-slate-100 text-center text-slate-400 text-sm">
        <p>© 2024 AccelMail & AccelAnalysis. All Rights Reserved.</p>
      </footer>
    </div>
  );
}